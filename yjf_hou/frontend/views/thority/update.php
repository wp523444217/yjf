					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="?r=thority/updatedo" method="post" onsubmit="return submitTest();">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="controller" value="<?=$data['controller']?>" placeholder="控制器名" class="col-xs-10 col-sm-5"/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="action" value="<?=$data['action']?>" placeholder="方法名" class="col-xs-10 col-sm-5"/>
										</div>
									</div>
